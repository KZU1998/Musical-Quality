   ...
   function route()
   {
      switch (strtolower($this->datosURI->accion)){
         ...
         case "leer_filtrado":
            ...
            break;
         case "crear":
            return $this->controlador->crear(new Usuario($this->datosURI->mensaje_body["idUsuario"]));
            break;
         case "actualizar":
            return $this->controlador->actualizar(new Usuario($this->datosURI->mensaje_body["idUsuario"]));
            break;
      }
   }
}